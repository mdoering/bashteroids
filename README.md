...
| **Mine**   | none      | 1 bullet (or auto) | Drops at a random interior point with no warning, flashes for 6 s, then explodes in a 120 px radius — anything inside dies (shields are consumed by the blast). Joins from level 4. | 5 (blast) |
